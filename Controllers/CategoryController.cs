...
namespace astute.Controllers
{
    ...
    public partial class CategoryController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllCategory(int colId)
        {
            try
            {
                var result = await _categoryService.GetCategoriesByColId(colId);
        ...
        [HttpGet]
        [Route("getcategorybycatid")]
        public async Task<IActionResult> GetCategoryByCatId(int catId)
        {
            try
            {
                var result = await _categoryService.GetCategoryById(catId);
                if (result != null)
                {
                    return Ok(new
                    {
